...
import {StyleSheet, View,ScrollView, Text,StatusBar,Alert,TouchableWithoutFeedback, Dimensions,TouchableOpacity,TextInput,Keyboard,KeyboardAvoidingView} from 'react-native';
...
export default class SignInComponent extends React.Component{
    ...
    ForgetPassword = (user_id) =>{
        ...
        .then(() => {
            Alert.alert("Password reset link was send via email");
         ...
         enabled
          ...
          >
           ...
           <ScrollView style={styles.scrollView}>
               ...
               <Text style={styles.text_footer_heading}> FORGET PASSWORD</Text>
            ...
            <View style={styles.button}>
                ...
                style={styles.signIn}
                >
                    <Text style={[styles.textSign,{color:'white'}]}>Send reset email</Text>
                </LinearGradient>
                </TouchableOpacity>
            </View>
